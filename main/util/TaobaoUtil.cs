...
public class TaobaoUtil
{
    ...
    public static CouponItem get_coupon(CmsForm cmsForm,string coupon_url, String num_iid, String pid,out string money)
    {
        money = "";
             ...
             && !string.IsNullOrEmpty(pid))
        {
            ...
            //LogUtil.log_call(cmsForm, string.Concat("money士大夫士大夫似的：", money.ToString()));
            try
            {
