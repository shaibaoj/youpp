    ...
    public class UserUtil
    {
        ...
        public static UserCmsBean query_taoke_item_list_html(CmsForm cmsForm)
        {
            ...
            try
            {
                ...
                String user_key = cmsForm.appBean.user_token;
                String user_name = cmsForm.appBean.user_name;
                String user_taoke_url = "http://" + Constants.api_url +"/"+ app_id + ".html";
        ...
        public static GoodsItem query_goods(CmsForm cmsForm, string num_iid,out string out_log)
        {
            try
            {
                ...
                ////LogUtil.log_cms_call(cmsForm, "user_id=" + user_id + "&num_iid=" + num_iid + "&member_token=" + user_key);
                //String body = httpservice.post_http(user_goods_url, "user_id=" + user_id + "&num_iid=" + num_iid + "&member_token=" + user_key, null);
        ...
        public static string query_user_sms(CmsForm cmsForm)
        {
            ...
            String body = httpservice.post_http(sms_url, "user_id=" + user_id + "&app_id=" + app_id + "&member_token=" + user_key, null);
        ...
        public static void query_user_cms_tongzhi(CmsForm cmsForm, out string out_log)
        {
            ...
            try
            {
                ...
                //String body = httpservice.post_http(cms_tongzhi_url, "user_id=" + user_id + "&app_id=" + app_id + "&member_token=" + user_key, null);
            }
            catch (Exception exception)
            {
                out_log = "出错啦！！！" + exception.ToString();
                    ...
                    try
                    {
                            ...
                            && jo["result"]["map"]["item"] != null)
                        {
                            ...
                            if (msg.Equals("ok"))
                            {
                                ...
                                cmsForm.appBean.user_token = jo["result"]["map"]["item"]["user_token"].ToString();
